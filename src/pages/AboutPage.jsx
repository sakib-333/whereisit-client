    ...
    <div className="min-h-screen text-text bg-background flex items-center justify-center p-6">
      <div className="max-w-3xl bg-secondary shadow-xl rounded-2xl p-8 space-y-6">
        ...
        <p className="text-lg text-center">
          Welcome to our Lost and Found platform! Our mission is to help people
          reunite with their lost belongings and return found items to their
          rightful owners.
        </p>
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside ">
            ...
            <li>Connect with the right person to return or claim the item.</li>
          </ul>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold text-secondary">Our Vision</h2>
          <p>
            We believe in a community-driven approach to lost and found, making
            it easier for people to help each other and reduce the stress of
